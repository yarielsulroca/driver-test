<?php
/**
 * Script para insertar 120 preguntas completas de tránsito argentino
...
try {
    ...
    echo "🚦 INSERTANDO 120 PREGUNTAS COMPLETAS DE TRÁNSITO ARGENTINO\n";
    echo "==========================================================\n\n";
...
function insertarTodasLasPreguntas($pdo) {
    $preguntas = [
        ...
        [
            'enunciado' => '¿Qué distancia mínima debe mantener un vehículo del que lo precede en autopistas?',
            'tipo_pregunta' => 'unica',
            'categoria_id' => 1,
            'dificultad' => 'facil',
            'respuestas' => [
        ...
        [
            'enunciado' => '¿Cuál es la velocidad máxima en avenidas de la Ciudad de Buenos Aires?',
            'tipo_pregunta' => 'unica',
            'categoria_id' => 1,
            'dificultad' => 'facil',
            'respuestas' => [
        ...
        [
            'enunciado' => '¿Qué debe hacer un conductor ante un semáforo en amarillo?',
            'tipo_pregunta' => 'unica',
            'categoria_id' => 1,
            'dificultad' => 'medio',
            'respuestas' => [
        ...
        [
            'enunciado' => '¿En qué horarios está prohibido tocar bocina en la Ciudad de Buenos Aires?',
            'tipo_pregunta' => 'unica',
            'categoria_id' => 1,
            'dificultad' => 'medio',
            'respuestas' => [
        ...
        [
            'enunciado' => '¿Cuál es la distancia mínima para estacionar de un hidrante?',
            'tipo_pregunta' => 'unica',
            'categoria_id' => 1,
            'dificultad' => 'medio',
            'respuestas' => [
        ...
        [
            'enunciado' => '¿Qué indica un semáforo con luz roja intermitente?',
            'tipo_pregunta' => 'unica',
            'categoria_id' => 1,
            'dificultad' => 'medio',
            'respuestas' => [
        ...
        [
            'enunciado' => '¿Qué indica una señal de "CEDA EL PASO"?',
            'tipo_pregunta' => 'unica',
            'categoria_id' => 2,
            'dificultad' => 'medio',
            'respuestas' => [
        ...
        [
            'enunciado' => '¿Qué significa una señal de "PROHIBIDO ESTACIONAR"?',
            'tipo_pregunta' => 'unica',
            'categoria_id' => 2,
            'dificultad' => 'facil',
            'respuestas' => [
        ...
        [
            'enunciado' => '¿Qué indica una señal de "VELOCIDAD MÁXIMA"?',
            'tipo_pregunta' => 'unica',
            'categoria_id' => 2,
            'dificultad' => 'facil',
            'respuestas' => [
